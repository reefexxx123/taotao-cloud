...
import com.taotao.cloud.file.biz.mapper.FileMapper;
import com.taotao.cloud.file.biz.service.IFileService;
import com.taotao.cloud.file.biz.utils.FileUtil;
...
public abstract class AbstractIFileService extends ServiceImpl<FileMapper, FileInfo> implements IFileService {
    ...
    public PageResult<FileInfo> findList(Map<String, Object> params) {
        ...
        return PageResult.<FileInfo>builder().data(list).code(0).total(page.getTotal()).build();
    }
}
